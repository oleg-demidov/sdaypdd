OKSDK = (function () {
    ...
    function init(args, success, failure) {
        if(args.login === undefuned) args.login = true;
        ...
        state.sessionSecretKey = params["session_secret_key"] || hParams['session_secret_key'] || args.app_secret;
        ...
        if (!params['api_server'] && args.login) {
            if ((hParams['access_token'] == null) && (hParams['error'] == null)) {
                console.log('auth1', hParams)
    ...
    function widgetOpen(widget, args, returnUrl) {
        ...
        sigSource += state.sessionSecretKey;//'874877CAFF43BB7F842C3F1C'
        console.log(sigSource);
