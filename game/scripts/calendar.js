...
dict.calendar = {
	div:'-', 
	table:{
		'2011-10-31':'Õýëëîóèí — êàíóí Äíÿ âñåõ ñâÿòûõ', 
		'2011-11-01':'Äåíü ñóäåáíîãî ïðèñòàâà',
		'2011-11-19':'Äåíü ðàêåòíûõ âîéñê è àðòèëëåðèè',
		'2011-12-12':'Äåíü Êîíñòèòóöèè Ðîññèéñêîé Ôåäåðàöèè',
		'2011-12-31':'Äåíü Ñóðêà'
	}
};
...
-function () {
	...
	lang = {
		...
		mm:['Январь', 'Февраль', 'Март', 'Апрель', 'Май', 'Июнь', 'Июль', 'Август', 'Сентябрь', 'Октябрь', 'Ноябр', 'Декабрь'],
...
/** ïîëå ââîäà (ì.á. select, åñëè åñòü ñïèñîê îïöèé - idxs)
* @params = {
*  type:string, name:string, id:string, value...
* }
* @el:string
* @idxs:array - òîëüêî äëÿ ýëåìåíòà select
*/
...
function hidTemp() { /* Ñïðÿòàòü âñïëûâøåå <>*/
